                        ...
                        <div class="col-lg-5 mx-auto">
                            <div class="form-action-wrapper py-5">
                                <div class="form-group">
                                    <h3 class="fs-22 pb-3 fw-bold">Log in to {{env('APP_NAME')}}</h3>
                                ...
                                <div class="form-group">
                                    <label id="email"
                                           class="fs-14 text-black fw-medium lh-18">{{ __('Email Address') }}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="password"
                                               class="form-control form--control password-field form-control @error('password') is-invalid @enderror"
                                               type="password"
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between">
                                    <div class="custom-control custom-checkbox fs-14">
                                        ...
                                        <label class="custom-control-label custom--control-label form-check-label"
