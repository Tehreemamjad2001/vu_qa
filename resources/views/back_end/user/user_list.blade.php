                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="dataTables_filter " id="sample_1_filter">
                                    <form action="">
                                        ...
                                        <a href="{{route('user-list')}}"><input class="btn red" type="button"
                                                                                value="Reset"></a>
                                    </form>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTable" id="sample_1"
								...
								: activate to sort column ascending" style="width: 258px;">
                                        <a href="{{getSortPageURL('name')}}"> Name <i
                                                    ...
                                                    {{($sortDir) && $sort != "name" ? "fa fa-unsorted": ""}}
                                                            ">
                                            </i></a>
                                    </th>
								...
								" style="width: 400px;">
                                        <a href="{{getSortPageURL('email')}}"> Email <i
                                                    ...
                                                    {{($sortDir) && $sort != "email" ? "fa fa-unsorted": ""}}
                                                            ">
                                            </i></a>
                                    </th>
                                    <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1"
								...
								" style="width: 200px;">
                                        <a href="{{getSortPageURL('gender')}}"> Gender <i
                                                    ...
                                                    {{($sortDir) && $sort != "gender" ? "fa fa-unsorted": ""}}
                                                            ">
                                            </i></a>
                                    </th>
                                    ...
                                    <tr class="gradeX odd">
                                        ...
                                        <td class=" text-center" style="vertical-align: middle">
                                            ...
                                            <a name="delete" class="del_ete  btn default"
                                               href="{{route('user-delete',["id"=>$list->id])}}"><b>Delete </b><span
                                                        class="fa fa-trash-o"></span></a>
                                            <a class="btn default"
                                               href="{{route('user-edit',["id"=>$list->id])}}"><b>Edit </b><span
