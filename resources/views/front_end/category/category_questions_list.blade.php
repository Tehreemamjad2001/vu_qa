                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <div class="sidebar-questions pt-3">
                                    @foreach($selectRandomQuestions as $item)
                                        @php
                                        $time = getTimeAgo($item->created_at);
                                        @endphp
                                        <div class="media media-card media--card media--card-2">
                                            <div class="media-body">
                                                <h5><a href="question-details.html">{{$item->title}}</a></h5>
                                                <small class="meta">
                                                    <span class="pr-1">{{$time}}</span>
                                                    <span class="pr-1">. by</span>
                                                    <a href="{{route("category-questions-list",["id"=>$id])}}" class="author">{{$item->name}}</a>
                                                </small>
                                            </div>
                                        </div><!-- end media -->
