    ...
    <section class="hero-area pt-80px pb-50px bg-white shadow-sm">
        ...
        <div class="container">
            <div class="hero-content text-center pb-5">
                <h2 class="section-title pb-3 theme-font-2 fs-40">The Social {{env('APP_NAME')}} Community</h2>
            ...
            <div class="row">
                <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                    <svg class="mr-3" width="45px" height="45px" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                    <svg class="mr-3" width="45px" height="45px" viewBox="0 0 512 512"
                         xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <g>
                                <g>
                                    <path d="m80.267 7.5c-25.124 0-45.492 20.367-45.492 45.492v406.017c0 25.124 20.367 45.492 45.492 45.492h300.284c25.124 0 45.492-20.367 45.492-45.492v-333.882c0-7.913-3.143-15.501-8.738-21.096l-87.792-87.792c-5.595-5.595-13.184-8.738-21.096-8.738h-228.15z"
                                          fill="#f7f4f7"/>
                                    <g>
                                        <path d="m417.305 104.03-56.639-56.639v411.617c0 25.124-20.367 45.492-45.492 45.492h65.377c25.124 0 45.492-20.367 45.492-45.492v-333.881c0-7.913-3.143-15.502-8.738-21.097z"
                                              fill="#e0dde0"/>
                                    </g>
                                    <path d="m417.305 104.03-87.792-87.792c-2.55-2.55-5.518-4.584-8.738-6.051v78.211c0 13.459 10.911 24.37 24.37 24.37h78.211c-1.467-3.22-3.501-6.187-6.051-8.738z"
                                          fill="#efd133"/>
                                </g>
                                <g>
                                    <path d="m130.884 226.457h-36.596c-3.557 0-6.44-2.883-6.44-6.44v-36.596c0-3.557 2.883-6.44 6.44-6.44h36.596c3.557 0 6.44 2.883 6.44 6.44v36.596c0 3.557-2.883 6.44-6.44 6.44z"
                                          fill="#e49542"/>
                                    <path d="m130.884 319.784h-36.596c-3.557 0-6.44-2.883-6.44-6.44v-36.596c0-3.557 2.883-6.44 6.44-6.44h36.596c3.557 0 6.44 2.883 6.44 6.44v36.596c0 3.556-2.883 6.44-6.44 6.44z"
                                          fill="#95d6a4"/>
                                    <path d="m130.884 413.11h-36.596c-3.557 0-6.44-2.883-6.44-6.44v-36.596c0-3.557 2.883-6.44 6.44-6.44h36.596c3.557 0 6.44 2.883 6.44 6.44v36.596c0 3.557-2.883 6.44-6.44 6.44z"
                                          fill="#e07f84"/>
                                </g>
                                <g>
                                    <g>
                                        <path d="m429.739 292.024-31.709-31.709-5.735.339-153.687 153.687c-2.375 2.375-4.496 4.976-6.362 7.747l36.367 36.367c2.771-1.866 5.372-3.987 7.747-6.362l153.687-153.687z"
                                              fill="#e07f84"/>
                                        <path d="m271.514 456.351-37.164-37.164c-3.133 4.024-5.679 8.486-7.521 13.267l-15.809 41.028c-1.495 3.88 2.319 7.693 6.198 6.198l41.028-15.809c4.782-1.841 9.244-4.387 13.268-7.52z"
                                              fill="#a87f7f"/>
                                        <path d="m453.023 275.431-22.976 22.975-37.752-37.752 22.976-22.975 5.525.246 31.771 31.772z"
                                              fill="#d1ccd3"/>
                                    </g>
                                </g>
                                <path d="m269.924 71.035h-174.594c-4.132 0-7.483 3.35-7.483 7.483v26.769c0 4.132 3.35 7.483 7.483 7.483h174.594c4.132 0 7.483-3.35 7.483-7.483v-26.77c0-4.132-3.35-7.482-7.483-7.482z"
                                      fill="#bed8fb"/>
                                <path d="m269.924 71.035h-65.377c4.132 0 7.482 3.35 7.482 7.483v26.769c0 4.133-3.35 7.483-7.482 7.483h65.377c4.132 0 7.482-3.35 7.482-7.483v-26.77c.001-4.132-3.349-7.482-7.482-7.482z"
                                      fill="#9dc6fb"/>
                            </g>
                            <path d="m469.422 221.279c10.425 10.425 10.425 27.327 0 37.752l-16.4 16.4-37.752-37.752 16.4-16.4c10.425-10.425 27.327-10.425 37.752 0z"
                                  fill="#88a8d8"/>
                            <g>
                ...
                <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                    <svg class="mr-3" width="45px" height="45px" viewBox="0 0 512 512"
                        ...
                        <g>
                            <g>
                                <path d="m483.375 275.673c-22.532-28.534-38.683-36.819-38.683-36.819h-377.385s-16.151 8.285-38.683 36.819c-9.528 12.066-6.42 29.753 6.609 37.914 28.293 17.722 77.555 52.959 124.079 107.678h193.374c46.525-54.719 95.786-89.956 124.079-107.678 13.031-8.162 16.138-25.848 6.61-37.914z"
                                      fill="#ff748f"/>
                                <path d="m188.333 414.829c-58.545-68.856-120.534-113.198-156.137-135.498-1.453-.91-2.804-1.919-4.058-3.004-8.918 12.043-5.701 29.245 7.097 37.261 28.293 17.722 77.555 52.959 124.079 107.678z"
                                      fill="#fd5f7e"/>
                                <path d="m50.59 212.91c0-113.263 92.147-205.41 205.41-205.41 113.264 0 205.41 92.147 205.41 205.41z"
                                      fill="#77718c"/>
                                <path d="m276 8.476c-6.583-.639-13.252-.976-20-.976-113.263 0-205.41 92.147-205.41 205.41h40c0-106.516 81.497-194.346 185.41-204.434z"
                                      fill="#5c586f"/>
                                <circle cx="426.995" cy="230.609" fill="#ffbd86" r="40.451"/>
                                <path d="m332.358 368.749s80.291 41.586 80.291 135.751h-307.661c0-94.166 80.291-135.751 80.291-135.751z"
                                      fill="#76e6d5"/>
                                <path d="m210.279 368.748h-25s-80.291 41.586-80.291 135.751h25c0-94.165 80.291-135.751 80.291-135.751z"
                                      fill="#00d6bc"/>
                    ...
                    <div class="question-main-bar border-left border-left-gray pb-50px">
                        <div class="filters pb-4 pl-3 d-flex align-items-center justify-content-between">
                            <div class="mr-3">
                                ...
                                <p class="pt-1 fs-14 fw-medium lh-20">{{$questionRecord->total()}}</p>
                            </div>

                            <div class="filter-option-box w-20">
                                <select class="select-container" id="sort">
                        ...
                        <div class="pager d-flex flex-wrap align-items-center justify-content-between pt-30px px-3">
                            ...
                            <div class="filter-option-box w-20">
                                ...
                                <select class="select-container " size="1" id="limit">
