        ...
        <div class="container">
            <form action="{{route('contact')}}"  method="post"
                ...
                <div class="card-body row">
                    <div class="col-lg-7">
                        @if(Session::has('alert-contact-us-record'))
                            {!!Session::get('alert-contact-us-record')!!}
                        @endif
                        {{csrf_field()}}
                    ...
                    <div class="col-lg-5">
                        <div class="contact-information-wrap pl-4 border-left border-left-gray h-100">
                            ...
                            <p class="pt-3 pb-5">Business consulting excepteur sint occaecat cupidatat consulting non
                                proident.</p>
                            ...
                            <div class="social-icon-box pt-5">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block"
                                   href="#" target="_blank" title="Follow on Facebook">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block"
                                   href="#" target="_blank" title="Follow on Twitter">
                                    <svg focusable="false" class="svg-inline--fa fa-twitter fa-w-16" width="16px"
                                         height="16px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path fill="currentColor"
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block"
                                   href="#" target="_blank" title="Follow on Linkedin">
                                    <svg focusable="false" class="svg-inline--fa fa-linkedin fa-w-14" width="16px"
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block"
                                   href="#" target="_blank" title="Follow on Instagram">
                                    <svg focusable="false" class="svg-inline--fa fa-instagram-square fa-w-14"
