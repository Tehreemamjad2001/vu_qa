    ...
    <div class="container">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <form method="post" class="mr-3 w-25">
                    <div class="form-group">
                        <input class="form-control form--control form-control-sm h-auto lh-34" type="text" name="search"
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="media media-card p-3 align-items-center hover-y">
                    <div class="icon-element shadow-sm flex-shrink-0 mr-3 border border-gray">
                        <svg class="svg-icon-color-gray" height="32" viewBox="0 0 512 512" width="32"
                    ...
                    <div class="media-body">
                        <h5 class="fs-19 fw-medium mb-1"><a href="category.html">Science</a></h5>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="media media-card p-3 align-items-center hover-y">
                    <div class="icon-element shadow-sm flex-shrink-0 mr-3 border border-gray">
                        <svg class="svg-icon-color-gray" enable-background="new 0 0 24 24" height="30"
                            ...
                            <g id="XMLID_1_">
                                ...
                                <path d="m5.505 17.505h.99v.99h-.99z"
                    ...
                    <div class="media-body">
                        <h5 class="fs-19 fw-medium mb-1"><a href="category.html">Physics</a></h5>
                        <p class="fw-medium fs-15 text-black-50 lh-18">1,200</p>
                    </div><!-- end media-body -->
                </div><!-- end media -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="media media-card p-3 align-items-center hover-y">
                    <div class="icon-element shadow-sm flex-shrink-0 mr-3 border border-gray">
                        <svg class="svg-icon-color-gray" height="38" viewBox="0 0 512 512" width="38"
                             xmlns="http://www.w3.org/2000/svg">
                            <path d="m40 424h208a8.00008 8.00008 0 0 0 8-8v-30.47632l40.2334-101.761a19.99983 19.99983 0 0 0 -18.43164-27.76268h-123.251a23.97611 23.97611 0 0 0 -22.06055 14.54541c-.02734.06543-.05468.13086-.08105.19678l-41.83836 105.25781h-66.5708a8.00008 8.00008 0 0 0 -8 8v16a24.02718 24.02718 0 0 0 24 24zm200-16h-64a8.00917 8.00917 0 0 1 -8-8v-8h72zm-92.76855-131.23145a7.992 7.992 0 0 1 7.31933-4.76855h123.251a3.99957 3.99957 0 0 1 3.67578 5.57568c-.0293.06983-.05859.13965-.08594.21l-38.83107 98.21432h-134.77149zm-115.23145 115.23145h120v8a23.88238 23.88238 0 0 0 1.37622 8h-113.37622a8.00917 8.00917 0 0 1 -8-8z"/>
                            <path d="m272 408v16h136a8.00008 8.00008 0 0 0 8-8v-88h56a24.02718 24.02718 0 0 0 24-24v-192a24.02718 24.02718 0 0 0 -24-24h-264a24.02718 24.02718 0 0 0 -24 24v128h16v-128a8.00917 8.00917 0 0 1 8-8h264a8.00917 8.00917 0 0 1 8 8v192a8.00917 8.00917 0 0 1 -8 8h-176v16h16v56h-40v16h112a8.00008 8.00008 0 0 0 8-8v-64h8v80zm104-24h-48v-56h16v16a8 8 0 0 0 16 0v-16h16z"/>
                            <circle cx="160" cy="288" r="8"/>
                            <circle cx="184" cy="288" r="8"/>
                            <circle cx="216" cy="120" r="8"/>
                            <circle cx="240" cy="120" r="8"/>
                            <circle cx="264" cy="120" r="8"/>
                            <path d="m322.34277 245.65674 24 24 11.31446-11.31348-18.34375-18.34326 18.34375-18.34326-11.31446-11.31348-24 24a8 8 0 0 0 0 11.31348z"/>
                            <path d="m437.65723 269.65674 24-24a8 8 0 0 0 0-11.31348l-24-24-11.31446 11.31348 18.34375 18.34326-18.34375 18.34326z"/>
                            <path d="m331.074 232h121.852v16.001h-121.852z"
                                  transform="matrix(.394 -.919 .919 .394 16.989 505.764)"/>
                            <path d="m216 152h16v16h-16z"/>
                            <path d="m248 152h56v16h-56z"/>
                            <path d="m216 184h16v16h-16z"/>
                            <path d="m248 184h32v16h-32z"/>
                            <path d="m216 216h16v16h-16z"/>
                            <path d="m248 216h48v16h-48z"/>
                            <path d="m320 152h32v16h-32z"/>
                        </svg>
                    </div>
                    <div class="media-body">
                        <h5 class="fs-19 fw-medium mb-1"><a href="category.html">Programmers</a></h5>
                        <p class="fw-medium fs-15 text-black-50 lh-18">1,200</p>
                    </div><!-- end media-body -->
                </div><!-- end media -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="media media-card p-3 align-items-center hover-y">
                    ...
                    <div class="media-body">
                        <h5 class="fs-19 fw-medium mb-1"><a href="category.html">Chemistry</a></h5>
                        <p class="fw-medium fs-15 text-black-50 lh-18">1,200</p>
                    </div><!-- end media-body -->
                </div><!-- end media -->
            </div><!-- end col-lg-3 -->
